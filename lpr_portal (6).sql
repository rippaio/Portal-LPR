...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 02, 2017 at 11:23 PM
...
--
ALTER TABLE `lpr_triplog`
  MODIFY `triplog_tripid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=135;
--
...
--
-- Constraints for table `lpr_client`
--
ALTER TABLE `lpr_client`
  ADD CONSTRAINT `lpr_client_ibfk_1` FOREIGN KEY (`zone_id`) REFERENCES `lpr_zones` (`zone_id`);
...
--
ALTER TABLE `lpr_rates`
  ADD CONSTRAINT `lpr_rates_ibfk_1` FOREIGN KEY (`zone_id`) REFERENCES `lpr_zones` (`zone_id`);
...
--
-- Constraints for table `lpr_triplog`
--
ALTER TABLE `lpr_triplog`
  ADD CONSTRAINT `lpr_triplog_ibfk_1` FOREIGN KEY (`triplog_o_id`) REFERENCES `lpr_order` (`o_id`),
  ADD CONSTRAINT `lpr_triplog_ibfk_2` FOREIGN KEY (`triplog_client_id`) REFERENCES `lpr_client` (`client_id`),
  ADD CONSTRAINT `lpr_triplog_ibfk_3` FOREIGN KEY (`triplog_school_id`) REFERENCES `lpr_school` (`school_id`),
  ADD CONSTRAINT `lpr_triplog_ibfk_4` FOREIGN KEY (`triplog_driver_id`) REFERENCES `lpr_driver` (`driver_id`),
  ADD CONSTRAINT `lpr_triplog_ibfk_5` FOREIGN KEY (`triplog_studentid`) REFERENCES `lpr_student` (`s_id`);
