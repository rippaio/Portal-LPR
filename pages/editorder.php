                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control input-sm" name="icomment" rows="3" value="<?php echo $subject["o_icomment"]; ?>"></textarea>
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleTextarea">Driver Comment</label>
                                                <textarea class="form-control input-sm" name="dcomment" rows="3" value="<?php echo $subject["o_dcomment"]; ?>"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
