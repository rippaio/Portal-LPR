    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="form-group">
                    <input type="text" class="form-control" id="exampleInputEmail3" name="sc_address" placeholder="Addresss line 2" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <input type="text" class="form-control" id="exampleInputEmail3" name="sc_zip" type="number" placeholder="Postal / Zip Code" required>
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" id="exampleInputEmail3" name="sc_country" placeholder="Country" required>
                </div>
