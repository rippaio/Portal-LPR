...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 09, 2017 at 06:10 PM
...
DROP TABLE IF EXISTS `lpr_additnltrip`;
...
DROP TABLE IF EXISTS `lpr_cashadvance`;
...
DROP TABLE IF EXISTS `lpr_dates`;
...
DROP TABLE IF EXISTS `lpr_invoice`;
...
DROP TABLE IF EXISTS `lpr_payroll`;
...
DROP TABLE IF EXISTS `lpr_ridealong`;
...
DROP TABLE IF EXISTS `lpr_triplog`;
...
DROP TABLE IF EXISTS `lpr_zones`;
...
--
ALTER TABLE `lpr_invoice`
  MODIFY `invoice_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=537;
--
...
--
ALTER TABLE `lpr_payroll`
  MODIFY `pl_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
...
--
ALTER TABLE `lpr_school`
  MODIFY `school_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=436;
--
...
--
ALTER TABLE `lpr_triplog`
  MODIFY `triplog_tripid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=116;
--
